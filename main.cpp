...
int main()
{
	...
	//7.5
	Polygon haromszog;
	haromszog.add(Point{350,250});
	haromszog.add(Point{300,50});
	haromszog.add(Point{410,200});
	haromszog.set_color(Color::blue);
	haromszog.set_style(Line_style::dash);
	
	//7.6
	Rectangle teglalap {Point{100,100}, 50, 100};
	...
	Image cal {Point{225,225},"image.jpg"};
